...
class ResultWindow(QWidget):
    ...
    def setup(self):
        ...
        pix_map = QPixmap('./resources/img/img2.png')
        pix_label.setPixmap(pix_map)
        pix_label.move(int((width - 193)//2),0)
...
class StartWindow(QWidget):
    ...
    def setup(self):
        ...
        self.search_line_edit.move(int((width - 400)//2),200)
...
if __name__ == '__main__':
    browser = Browser('./resources/data/corpus.txt')
    finder = ArticleFinder('./resources/data/corpus.txt')
    app = QApplication([])
